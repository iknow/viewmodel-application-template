...
gem 'fastimage'  # parses image size and type without reading entire image
gem 'mime-types' # registry of MIME content types
gem 'ruby-filemagic' # Bindings to magic library (detect file types from content)
gem 'mp3info'    # pure ruby mp3 parser
...
group :development do
  ...
  gem 'annotaterb', groups: [:development]
