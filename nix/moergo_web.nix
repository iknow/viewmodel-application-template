...
let
  ...
  bundleProdEnv = bundlerEnv {
    name = "moergo_web-bundler-prod-env";
  ...
  moergo_web = stdenv.mkDerivation {
    name    = "moergo_web";
    version = "0.0.1";
...
in
{
  inherit bundleEnv bundleProdEnv moergo_web runtimeDependencies;
}
